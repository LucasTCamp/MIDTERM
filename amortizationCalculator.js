...
button1.addEventListener("click", function() {
    let origLoan = parseInt(prompt("Enter loan amount"));
    let downPayment = parseInt(prompt("Give the down payment"));
    ...
    output.textcontent = `Loan Term: ${loanTerm}`;
    ...
    for(let month = 1; month <= totalMonths; month++) {
        ...
        table.textContent = `Month: ${month} Interest: $${interestPaid.tofixed(2)} Principle = $${PrinciplePaid.tofixed(2)}`;
